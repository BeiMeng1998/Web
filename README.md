...
- [目录](#目录)
- [HTML](#html)
  - [!DOCTYPE文档声明的作用](#doctype文档声明的作用)
  - [行内元素](#行内元素)
  - [块元素](#块元素)
  - [空元素](#空元素)
  - [attribute与property](#attribute与property)
  - [HTML自定义属性](#html自定义属性)
  - [meta标签](#meta标签)
  - [img的title和alt有什么区别](#img的title和alt有什么区别)
  - [HTML5新特性](#html5新特性)
  - [HTML5语义化标签](#html5语义化标签)
    - [hgroup](#hgroup)
    - [header](#header)
    - [nav](#nav)
    - [section](#section)
    - [article](#article)
    - [aside](#aside)
  - [HTML5删除的标签](#html5删除的标签)
  - [shadow dom是什么](#shadow-dom是什么)
  - [SVG和Canvas的区别](#svg和canvas的区别)
- [CSS相关](#css相关)
  - [两种盒模型](#两种盒模型)
  - [列举几个css中可继承和不可继承的属性](#列举几个css中可继承和不可继承的属性)
  - [伪类和伪元素的区别](#伪类和伪元素的区别)
  - [CSS filter](#css-filter)
  - [CSS选择器](#css选择器)
  - [CSS选择器优先级](#css选择器优先级)
    - [1.首先按来源排序](#1首先按来源排序)
    - [2.按选择器的特殊性排序](#2按选择器的特殊性排序)
    - [3.顺序排序](#3顺序排序)
  ...
  - [三列布局](#三列布局)
    ...
    - [flex布局](#flex布局)
    - [Grid布局](#grid布局)
  - [绝对定位模拟固定定位](#绝对定位模拟固定定位)
  - [垂直排列兄弟元素margin重叠问题](#垂直排列兄弟元素margin重叠问题)
  - [父子元素margin传递问题](#父子元素margin传递问题)
  - [子元素浮动高度塌陷](#子元素浮动高度塌陷)
  - [IE CSS hack](#ie-css-hack)
  - [盒模型相关属性默认值](#盒模型相关属性默认值)
  - [盒模型百分比属性](#盒模型百分比属性)
  - [元素垂直水平居中方案](#元素垂直水平居中方案)
    - [不使用定位](#不使用定位)
      - [flex](#flex)
      - [Grid](#grid)
    - [使用定位](#使用定位)
  - [CSS隐藏元素](#css隐藏元素)
    ...
    - [position: absolute;+z-index : -9999;](#position-absolutez-index---9999)
    - [overflow:hidden;](#overflowhidden)
    - [visibility:hidden;](#visibilityhidden)
    - [transform:scale(0,0);](#transformscale00)
    - [opacity:0;](#opacity0)
  - [px em rem vw vh vmin vmax](#px-em-rem-vw-vh-vmin-vmax)
  - [响应式布局方案](#响应式布局方案)
    - [媒体查询](#媒体查询)
    - [百分比布局](#百分比布局)
    - [rem布局](#rem布局)
    - [viewport布局](#viewport布局)
    - [vw/vh布局](#vwvh布局)
    - [flex布局](#flex布局-1)
    - [grid布局](#grid布局-1)
  - [CSS画底为40px高为40px的等腰三角形](#css画底为40px高为40px的等腰三角形)
  - [CSS画一个扇形](#css画一个扇形)
- [JavaScript相关](#javascript相关)
  - [JS实现函数柯里化+偏函数组合应用](#js实现函数柯里化偏函数组合应用)
  - [JS中为什么 0.1+0.2 !== 0.3](#js中为什么-0102--03)
  - [隐式转换](#隐式转换)
  - [包装类](#包装类)
  - [this指向](#this指向)
  - [call() apply() bind()的区别](#call-apply-bind的区别)
  - [new的执行过程](#new的执行过程)
  - [DOM增删改查](#dom增删改查)
    - [查](#查)
      - [通过方法获取](#通过方法获取)
        - [1.获取单个元素](#1获取单个元素)
        - [2.获取HTMLCollection动态伪数组](#2获取htmlcollection动态伪数组)
        - [3.获取NodeList静态伪数组](#3获取nodelist静态伪数组)
      - [通过属性获取](#通过属性获取)
        - [1.获取子节点/子元素](#1获取子节点子元素)
        - [2.获取父节点](#2获取父节点)
        - [3.兄弟节点/兄弟元素](#3兄弟节点兄弟元素)
    - [增](#增)
    - [改](#改)
    - [删](#删)
  - [DOM绑定/解绑监听](#dom绑定解绑监听)
  - [事件流](#事件流)
    - [捕获阶段](#捕获阶段)
    - [目标阶段](#目标阶段)
    - [冒泡阶段](#冒泡阶段)
  - [事件委派（利用事件冒泡）](#事件委派利用事件冒泡)
  - [JS引擎如何管理内存](#js引擎如何管理内存)
    - [内存的生命周期](#内存的生命周期)
    - [释放内存](#释放内存)
  - [JavaScript垃圾回收机制](#javascript垃圾回收机制)
    - [标记清除](#标记清除)
    - [引用清除](#引用清除)
  - [原型与原型链](#原型与原型链)
    - [显式原型与隐式原型](#显式原型与隐式原型)
  ...
  - [词法环境](#词法环境)
    - [环境记录](#环境记录)
      - [声明式环境记录](#声明式环境记录)
      - [对象式环境记录](#对象式环境记录)
    - [对外部词法环境的引用(outer)](#对外部词法环境的引用outer)
  - [ES5严格模式语法和行为的改变](#es5严格模式语法和行为的改变)
  - [let与const](#let与const)
    - [let](#let)
    - [const](#const)
  - [...三点运算符](#三点运算符)
  ...
  - [浅拷贝与深拷贝](#浅拷贝与深拷贝)
    - [浅拷贝](#浅拷贝)
    - [深拷贝](#深拷贝)
    - [JSON.parse(JSON.stringify(result))](#jsonparsejsonstringifyresult)
    - [递归实现深拷贝](#递归实现深拷贝)
  - [如何判断是否是数组](#如何判断是否是数组)
    - [instanceof](#instanceof-1)
    - [param.constructor === Array](#paramconstructor--array)
    - [Object.prototype.toString.call(param).slice(8, -1)](#objectprototypetostringcallparamslice8--1)
    - [Array.isArray(param)](#arrayisarrayparam)
  - [数组去重](#数组去重)
  - [判断一个对象是否是空对象](#判断一个对象是否是空对象)
  - [伪数组转数组](#伪数组转数组)
    - [`[...param]`(有限)](#param有限)
    - [Array.prototype.slice.call(param)](#arrayprototypeslicecallparam)
    - [Array.from(param) 接受伪数组和可迭代对象](#arrayfromparam-接受伪数组和可迭代对象)
  - [super关键字 与 super()](#super关键字-与-super)
    - [super关键字](#super关键字)
    - [super()](#super)
  - [class关键字](#class关键字)
  - [Promise](#promise)
    ...
    - [如何让Promise.all()在抛出异常后依然有效?](#如何让promiseall在抛出异常后依然有效)
  - [简述箭头函数](#简述箭头函数)
  - [for in 和 for of 和 Object.keys()的区别](#for-in-和-for-of-和-objectkeys的区别)
    - [for in](#for-in)
    - [for of](#for-of)
...
- [Web相关](#web相关)
  ...
  - [跨域的解决方案](#跨域的解决方案)
    ...
    - [nginx反向代理](#nginx反向代理)
    - [Websocket](#websocket)
  - [浏览器内核(render进程)多线程](#浏览器内核render进程多线程)
    - [主线程](#主线程)
      - [JS引擎线程与GUI渲染线程互斥](#js引擎线程与gui渲染线程互斥)
      - [JS引擎线程（V8引擎中JS编译执行过程）](#js引擎线程v8引擎中js编译执行过程)
      - [GUI渲染线程](#gui渲染线程)
      - [重绘回流与硬件加速](#重绘回流与硬件加速)
    - [Web API分线程](#web-api分线程)
      - [定时器管理线程](#定时器管理线程)
      - [DOM事件响应线程](#dom事件响应线程)
      - [网络请求线程](#网络请求线程)
  - [浏览器数据本地存储方式](#浏览器数据本地存储方式)
    - [Cookies](#cookies)
    - [LocalStorage](#localstorage)
    - [SessionStorage](#sessionstorage)
    - [IndexedDB](#indexeddb)
  - [HTML5 manifest 离线缓存](#html5-manifest-离线缓存)
    - [原理](#原理)
    - [使用](#使用)
    - [离线缓存更新问题及解决方案](#离线缓存更新问题及解决方案)
  - [强制缓存与协商缓存](#强制缓存与协商缓存)
    - [强制缓存](#强制缓存)
      - [Expires (HTTP/1.0)](#expires-http10)
      - [Cache-Control (HTTP/1.1)](#cache-control-http11)
    - [协商缓存](#协商缓存)
      - [Last-Modified/If-Modified-Since (HTTP/1.0)](#last-modifiedif-modified-since-http10)
      - [Etag/If-None-Match (HTTP/1.1)](#etagif-none-match-http11)
      - [两种方法对比](#两种方法对比)
    - [缓存机制](#缓存机制)
    - [用户行为对缓存策略的影响](#用户行为对缓存策略的影响)
  - [详述输入URL到页面渲染的过程](#详述输入url到页面渲染的过程)
  - [如何实现SEO优化](#如何实现seo优化)
  - [详述回流和重绘优化](#详述回流和重绘优化)
  - [防抖和节流](#防抖和节流)
    - [函数防抖](#函数防抖)
...
- [HTTP](#http)
  ...
  - [TCP UDP](#tcp-udp)
    ...
    - [UDP](#udp)
  - [HTTP状态码](#http状态码)
    - [1XX（信息性状态码）](#1xx信息性状态码)
    - [2XX（成功状态码）](#2xx成功状态码)
    - [3XX（重定向状态码）](#3xx重定向状态码)
    - [4XX（客户端错误状态码）](#4xx客户端错误状态码)
    - [5XX（服务器错误状态码）](#5xx服务器错误状态码)
  - [HTTP的方法](#http的方法)
    - [GET：获取资源](#get获取资源)
    - [POST：主要用于提交数据](#post主要用于提交数据)
    - [PUT：上传文件](#put上传文件)
    - [HEAD：获得报文首部](#head获得报文首部)
    - [DELETE：删除文件](#delete删除文件)
    - [OPTIONS：询问支持的方法](#options询问支持的方法)
  ...
  - [HTTP2.0](#http20)
    - [HTTP1.1存在的问题](#http11存在的问题)
      - [1.TCP数量限制](#1tcp数量限制)
      - [2.线头阻塞问题](#2线头阻塞问题)
      - [3.Header内容过多，没有压缩优化方案](#3header内容过多没有压缩优化方案)
      - [4.为了尽可能减少请求数，需要做合并文件，雪碧图，资源内联等优化工作，造成单个请求延迟过高，且内联的资源不能有效地使用缓存机制](#4为了尽可能减少请求数需要做合并文件雪碧图资源内联等优化工作造成单个请求延迟过高且内联的资源不能有效地使用缓存机制)
    - [HTTP2.0的优势](#http20的优势)
      - [1.二进制分帧](#1二进制分帧)
      - [2.多路复用](#2多路复用)
      - [3.服务端推送](#3服务端推送)
      - [4.Header压缩](#4header压缩)
- [React相关](#react相关)
- [算法相关](#算法相关)
